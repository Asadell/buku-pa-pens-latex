...
% ── Styling header ditangani oleh SetTblrInner di atas ──────
...
% ── Mencegah Caption Terpisah dari Gambar/Tabel ──────────────
% \captionsetup dengan belowskip kecil agar caption selalu ikut objeknya.
% Penalty tinggi mencegah page break antara float dan captionnya.
\captionsetup{aboveskip=4pt, belowskip=4pt}

% FloatBarrier otomatis di setiap \section dan \subsection
% sehingga float tidak "terbang" melewati judul section berikutnya.
\makeatletter
